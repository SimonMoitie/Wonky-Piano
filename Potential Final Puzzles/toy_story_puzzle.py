...
levelTwoMelody = [
    ...
    (c5, quarterNote, *buttonsAndPixels[2][1]),
    (aS4, halfNote, *buttonsAndPixels[1][1]),
    (c5, semiNote, *buttonsAndPixels[2][1]), 
    (dS5, semiNote, *buttonsAndPixels[5][1]), 
    (c5, semiNote, *buttonsAndPixels[2][1]), 
    (dS5, quarterNote, *buttonsAndPixels[5][1]), 
    (c5, semiNote, *buttonsAndPixels[2][1]),
    (aS4, halfNote, *buttonsAndPixels[1][1]),
    (dS5, quarterNote, *buttonsAndPixels[5][1]),
    (d5, semiNote, *buttonsAndPixels[4][1]),
...
levelThreeMelody = [
    ...
    (aS4, dS5, semiNote, *buttonsAndPixels[1][1], *buttonsAndPixels[5][1]),
    (g4, halfNote, *buttonsAndPixels[0][1]),
    (cS5, semiNote, *buttonsAndPixels[3][1]),
