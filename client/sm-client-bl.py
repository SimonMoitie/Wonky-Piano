...
def resetVariables():
    blinding_lights_puzzle.beamBroken = False
    blinding_lights_puzzle.completed = False
...
def blindingLightsLevelOne():
    ...
    while running:
        ...
        while blinding_lights_puzzle.completed == False:
                            
            blinding_lights_puzzle.levelOnePuzzle()
        ...
        blinding_lights_puzzle.fixedPiano()
    
# Function to run the level two puzzle
def blindingLightsLevelTwo():
    ...
    while running:
        ...
        while blinding_lights_puzzle.completed == False:
            ...
            blinding_lights_puzzle.levelTwoPuzzle()
...
def blindingLightsLevelThree():
    ...
    while running:
        ...
        while blinding_lights_puzzle.completed == False:
            ...
            blinding_lights_puzzle.levelThreePuzzle()
...
def stopPuzzleLevel():
    ...
    stopThread.set()
    time.sleep(0.5)
    blinding_lights_puzzle.stopPuzzle()
    puzzleThread.join() 
    stopThread.clear()  
...
def levelOneMelody():
    ...
    blinding_lights_puzzle.playMelodyLevelOne()
    device['actions'][1]['enabled'] = True
    device['status'] = "Level one running"
    hub.Update(device)
    blinding_lights_puzzle.userSolution.clear()
    blinding_lights_puzzle.matchingNotes = 0
    blinding_lights_puzzle.compareIndex = 0
    startPuzzleLevel(blindingLightsLevelOne)

def levelTwoMelody():
    stopPuzzleLevel()
    print("Playing level two clue...")
    blinding_lights_puzzle.playMelodyLevelTwo()
    ...
    blinding_lights_puzzle.matchingNotes = 0
    blinding_lights_puzzle.compareIndex = 0
    startPuzzleLevel(blindingLightsLevelTwo)

def levelThreeMelody():
    stopPuzzleLevel()
    print("Playing level three clue...")
    blinding_lights_puzzle.playMelodyLevelThree()
    ...
    blinding_lights_puzzle.matchingNotes = 0
    blinding_lights_puzzle.compareIndex = 0
    startPuzzleLevel(blindingLightsLevelThree)
...
try:
    ...
    # Tidy up
    blinding_lights_puzzle.audioOutput.close()
    blinding_lights_puzzle.pygame.midi.quit()
    blinding_lights_puzzle.pygame.quit()
